...
기존 도서 사이트 이용 시 정보가 과도하게 많아 핵심 기능에 집중하기 어려운 문제를 개선하고자,  
메인 화면을 단순화하고 사용자 흐름을 분리하여 설계한 도서 구매 사이트입니다.

사용자 행동 흐름을 기준으로 비회원/회원 접근 제어와 구매 과정을 구현했습니다.
...
- 프로젝트 기간: 2026.01.13 ~ 2026.01.23 (11일)
...
- 기존 도서 사이트의 정보 과다 문제를 개선하기 위해 사용자 유형을 분리하고 메인 화면을 단순화
...
- 구매 및 장바구니 과정에서 사용자 행동에 따른 화면 이동 및 상태 변화 로직 구현
